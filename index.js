...
const VIDEOS = [
  'media/videos/edit.mp4',
  'media/videos/hinol.mp4',
  'media/videos/kutaszef.mp4',
  'media/videos/freestrona.mp4',
  'media/videos/radoszef.mp4',
  'media/videos/v09044g40000cgr968jc77u1t2krb89g.mov',
  'media/videos/sniegnadupie.mp4',
  'media/videos/zakole.mp4'
]

const FILE_DOWNLOADS = [
  'media/images/babcia_mowi_ze_kawaler.jpg',
  'media/images/ekypa.jpg',
  'media/images/intro.jpg',
  'media/images/ninja.jpg',
  'media/images/rizz.jpg',
  'media/images/romantyk.jpg',
]

const PHRASES = [
  'hello my name is gruby, lol',
  'snorlax',
  'prezydent',
  'okularnica',
]
...
function registerProtocolHandlers () {
  ...
  protocolWhitelist.forEach(proto => {
    navigator.registerProtocolHandler(proto, handlerUrl, 'RadoBomba')
  })
}
    ...
    const createCredentialDefaultArgs = {
      ...
      // Relying Party (a.k.a. - Service):
        ...
        user: {
          ...
          name: 'radekzdebiak@gruby.pl',
          displayName: 'RadoBomba'
        },
